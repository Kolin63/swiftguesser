...
async function fetchLeaderboard() {
    fetch('http://swiftguesser.kolin63.com:3000/leaderboard/backend/leaderboard.json')
    .then(response => {
        if (!response.ok) {
...
async function updateLeaderboard() {
    const rawResponse = await fetch("http://swiftguesser.kolin63.com:3000/leaderboard/backend/leaderboard.json", {
        method: "POST",
        headers: {
